...
| LIVE_USERNAME | 🔒 | The name of the user whose profile will be created on first boot. If you specify the username **root**, then no user profile will be created, and login will be performed using the **root** profile. See `man 7 live-config`. | LIVE_USERNAME="live" |
